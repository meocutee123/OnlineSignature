...
{
    public class EmbeddedSigningCeremony
    {
        // <summary>
        ...
        public static EnvelopCreationResponse SendEnvelopeForEmbeddedSigning(string signerEmail, string signerName, string signerClientId,
            string accessToken, string basePath, string accountId, string docPdf, string returnUrl, string pingUrl = null)
        {
            // Step 1. Create the envelope definition
            var envelope = MakeEnvelope(signerEmail, signerName, signerClientId, docPdf);
            ...
            var viewRequest = MakeRecipientViewRequest(signerEmail, signerName, returnUrl, signerClientId, pingUrl);
            ...
            return new EnvelopCreationResponse { Id = envelopeId, Uri = redirectUrl };
        }
        ...
        private static EnvelopeDefinition MakeEnvelope(string signerEmail, string signerName, string signerClientId, string docPdf)
        {
            ...
            var doc1b64 = Convert.ToBase64String(buffer);
        ...
        //public static async Task<DownloadDocumentResponse> GetDocument(DownloadDocumentInfo downloadDocumentInfo)
        //{
        //    var apiClient = new ApiClient(downloadDocumentInfo.BasePath);
        //    apiClient.Configuration.DefaultHeader.Add("Authorization", "Bearer " + downloadDocumentInfo.AccessToken);

        //    EnvelopesApi envelopesApi = new EnvelopesApi(apiClient);
        //    var document = await envelopesApi.GetDocumentAsync(
        //      downloadDocumentInfo.AccountId,
        //      downloadDocumentInfo.EnvelopeId,
        //      downloadDocumentInfo.DocumentId
        //    );

        //    return new DownloadDocumentResponse();
        //}

        //public static async Task<UserSignature> GetRecipientSignature(GetRecipientSignatureInfo getRecipientSignatureInfo)
        //{
        //    var apiClient = new ApiClient(getRecipientSignatureInfo.BasePath);
        //    apiClient.Configuration.DefaultHeader.Add("Authorization", "Bearer " + getRecipientSignatureInfo.AccessToken);

        //    EnvelopesApi envelopesApi = new EnvelopesApi(apiClient);
        //    var userSignature = await envelopesApi.GetRecipientSignatureAsync(
        //      getRecipientSignatureInfo.AccountId,
        //      getRecipientSignatureInfo.EnvelopeId,
        //      getRecipientSignatureInfo.RecipientId
        //    );
